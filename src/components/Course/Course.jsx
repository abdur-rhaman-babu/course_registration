...
const Course = ({course, hundleBookmark}) => {
    ...
    return (
        <div className='border-solid border-2 border-purple-500 p-2 rounded shadow-md'>
            <img src={img} alt="" />
            ...
            <button onClick={()=>hundleBookmark(course)} className='bg-blue-600 rounded w-full p-1 text-white'>Select</button>
        </div>
    );
};
